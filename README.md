...
The application has five buttons next to each other.
...
The buttons that are "on" have a background color of green. The buttons that are "off" have a backgound color of gray.
